...
export class SolicitarTurnoComponent implements OnInit {
  ...
  // especialidades = ['Cardiología', 'Dermatología', 'Neurología'];
  // especialistas: Especialista[] = [
  //   { id:1, nombre:'Dr. Juan Pérez', especialidad:'Cardiología', imagenPerfil:'/assets/icons/doctor1.jpg', apellido:'', edad:0, dni:'', mail:'', password:'' },
  //   { id:2, nombre:'Dra. Marta López', especialidad:'Dermatología', imagenPerfil:'/assets/icons/doctor2.jpg', apellido:'', edad:0, dni:'', mail:'', password:'' },
  //   { id:3, nombre:'Dr. Carlos Ruiz', especialidad:'Neurología', imagenPerfil:'/assets/icons/healthcare.jpg', apellido:'', edad:0, dni:'', mail:'', password:'' }
  // ];
  ...
  // /** 1) Getter para la lista filtrada de especialistas */
  // get especialistasFiltrados(): Especialista[] {
  //   const esp = this.turnoForm.get('especialidad')?.value;
  //   return this.especialistas.filter(e => e.especialidad === esp);
  // }

  // /** 2) Getter para el especialista seleccionado */
  // get selectedEspecialista(): Especialista | undefined {
  //   const nombre = this.turnoForm.get('especialista')?.value;
  //   return this.especialistas.find(e => e.nombre === nombre);
  // }
  ...
  //     console.log('Turno confirmado:', this.turnoForm.value);
  //     // Llama aquí a tu servicio para guardar el turno...
  //   } else {
  //     this.turnoForm.markAllAsTouched();
  //   }
  // }
